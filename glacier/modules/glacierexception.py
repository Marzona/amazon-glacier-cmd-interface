...
error handling code from GlacierWrapper.py, allowing it to be
used in other modules like glaciercorecalls as well.
**********
...
class GlacierException(Exception):
    ...
    def __init__(self, message, code=None, cause=None):
        ...
        if cause:
            ...
            # ^^^ let's hope the information is still there;
    ...
    def causeTree(self, indentation='  ', alreadyMentionedTree=[],
        ...
        if message:
            ...
            for line in traceback.format_exception_only(exc.__class__,
                                                        exc):
                yield line
